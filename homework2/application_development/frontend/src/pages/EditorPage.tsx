...
import CodeRunnerActions from '../components/CodeRunnerActions'
...
export default function EditorPage({ sessionId }: EditorPageProps) {
  ...
  const [shareDialogLanguage, setShareDialogLanguage] = useState<string | undefined>(undefined)
      ...
      <div className={`main-content ${!isSidebarCollapsed ? 'sidebar-expanded' : ''}`}>
        ...
        <div className={`sidebar ${isSidebarCollapsed ? 'collapsed' : ''}`}>
          <div className="sidebar-header">
            ...
            <button 
              className="sidebar-close hamburger-close"
              onClick={(e) => {
                e.preventDefault()
                e.stopPropagation()
                console.log('Toggle sidebar clicked')
